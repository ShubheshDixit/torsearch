...
from tors import (__app_name__, __version__)

from tors import tors

from tors.constants import SOURCES, ASCII_ART

from tors.utils.config import create_config_file, load_config

from art import art

app = typer.Typer(name="tors", no_args_is_help=True, help=art("big eyes"))
